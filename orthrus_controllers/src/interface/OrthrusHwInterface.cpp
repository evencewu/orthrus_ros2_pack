...
{
    OrthrusHwInterface::OrthrusHwInterface(const rclcpp::Node::SharedPtr &node)
    {
        node_ = node;
    }

    OrthrusHwInterface::~OrthrusHwInterface()
    {
    }

    void OrthrusHwInterface::Init()
    {
        RCLCPP_INFO(node_->get_logger(), "OrthrusInterface init");
        orthrus_joint_state_sub_ = node_->create_subscription<orthrus_interfaces::msg::OrthrusJointState>("/orthrus_interface/joint_state", 10, std::bind(&OrthrusHwInterface::OrthrusJointStateSubCallback, this, std::placeholders::_1));
    ...
    void OrthrusHwInterface::OrthrusJointStateSubCallback(const orthrus_interfaces::msg::OrthrusJointState::SharedPtr msg)
    {
    ...
    void OrthrusHwInterface::OrthrusImuSubCallback(const sensor_msgs::msg::Imu::SharedPtr msg)
    {
